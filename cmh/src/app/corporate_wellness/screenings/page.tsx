    ...
    <div className="flex flex-col justify-center items-center w-full h-full">
      ...
      <section className="flex flex-col justify-center items-center w-full md:w-3/4">
        ...
        <Article
          ...
          paragraps={[
            "Midland Health offers customizable screening, based on the needs of your company. With our online scheduling system you will be able to customize your screening options from your desk. Unlike alternative programs, Midland Health screening is flexible and tailored to your company’s needs. Blood testing can be performed with the choice of venipuncture or finger stick, fasting or non-fasting. The finger stick option will provide immediate data; a venipuncture draw will be sent to one of our certified labs for analysis.  After labs are process the data is uploaded and ready for report production and distribution.",
          ]}
        />
        <Article
          title="Coverage Throughout The Usa — Screenings Day And Night"
          paragraps={[
            "Midland Health provides on-site testing services for companies ranging from one location to multiple satellite locations anywhere in the United States.  For multiple site screenings, we provide options to include all employees in your screening process.  Midland also screens 2nd and 3rd shifts as well as Saturdays at no additional charge.  It is about what is most convenient for you and your employees.",
          ]}
        />
        <Article
          title="Screening For Large Businesses"
          paragraps={[
            "For large populations employees at a single location, Midland Health uses MoxieMetrics software, a data collection system created by Midland Health, operated via iPad. MoxieMetrics offers faster and more accurate data transmissions for larger groups. With this software, we are able to accommodate multiple appointments and schedules for screenings at companies with 400+ employees.  The employee is able to view their data before it is transmitted and will digitally sign to verify their personal information is accurate.",
