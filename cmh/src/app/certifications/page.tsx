...
const page = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full h-full">
      <PageImage
        title="Pofessional Cerifications"
        subtitle=""
      ...
      <section className="flex flex-col justify-center items-center w-full md:w-3/5">
        <Article
          ...
          paragraps={[
            "Midland Health is a Department of Transportation certified Disadvantaged Business Enterprise. Partnering with Midland may fulfill government-driven obligations. Learn about what it means to be DBE Certified.",
        ...
        <Article
          ...
          paragraps={[
            "As a Women Owned Business, Midland Health is WBENC Certified by the LINKWomen’s Business Enterprise National CouncilLINKHREFhttps://www.wbenc.org/certification/.",
